...
public class TreePlanterBlockEntityRenderer implements BlockEntityRenderer<tile_entity_tree_planter> {
	...
	public TreePlanterBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) {
		this.context = ctx;
	}

	@Override
	public void render(@NotNull tile_entity_tree_planter te, float pPartialTick, @NotNull PoseStack poseStack,
