...
import com.qdc_mod.qdc_quantum_farming_2.quantum_farming_2.boxes.MainBox;
...
public class CropHarvesterBlockEntityRenderer implements BlockEntityRenderer<tile_entity_crop_harvester> {
	...
	public CropHarvesterBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) {
		this.context = ctx;
	}

	@Override
	public void render(@NotNull tile_entity_crop_harvester te, float pPartialTick, @NotNull PoseStack poseStack,
			@NotNull MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {

		ItemStack mainStack = te.getSeedStack();
		ItemStack sizeStack = te.getSizeStack();
