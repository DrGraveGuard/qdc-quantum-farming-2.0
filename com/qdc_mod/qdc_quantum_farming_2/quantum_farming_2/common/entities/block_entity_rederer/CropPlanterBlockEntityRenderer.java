...
public class CropPlanterBlockEntityRenderer implements BlockEntityRenderer<tile_entity_crop_planter> {
	...
	public CropPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) {
		this.context = ctx;
	}

	@Override
	public void render(@NotNull tile_entity_crop_planter te, float pPartialTick, @NotNull PoseStack poseStack,
